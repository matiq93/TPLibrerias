...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        lista.Agregar(new RevistaEspecializada("jardineria", 1, 5, 0, 75, "jardineria", 'A'));
        lista.Agregar(new RevistaDeOcio("Angel", 2, 2, 0, 50, "algo 1", 'A'));
        ...
        lista.Agregar(new RevistaEspecializada("cocina",3,  3, 1, 50, "cocina", 'A'));
        lista.Agregar(new RevistaDeOcio("David", 4, 3, 1, 65, "algo 2", 'A'));
        ...
        lista.Agregar(new RevistaEspecializada("economia",5,  4, 2, 66, "economia", 'A'));
        lista.Agregar(new RevistaDeOcio("matias", 6, 1, 2, 25, "algo 3", 'A'));
